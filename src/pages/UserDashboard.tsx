...
export default function UserDashboard() {
  ...
  useEffect(() => {
    ...
    if (!authService.isAuthenticated() || authService.getUserType() !== 'user') {
      navigate('/user/login');
      return;
    }
    ...
    const fetchUserData = async () => {
      try {
        ...
        // You should implement a /user/me endpoint in your backend
        const mockUser: UserData = {
          username: 'User', // Extract from JWT token or fetch from API
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">Gokeral</h1>
            </div>
            <div className="flex items-center">
              <button
